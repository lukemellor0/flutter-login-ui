...
class ReportsFragment extends StatefulWidget {
  ...
  @override
  _ExpansionPanelsReportsState createState() => _ExpansionPanelsReportsState();
}

class _ExpansionPanelsReportsState extends State<ReportsFragment> {
  ...
  void initState() {
    ...
    _demoItems = <DemoItem<dynamic>>[
      ...
      DemoItem<String>(
          name: 'Projects',
          value: 'Change current project',
          hint: 'Select a Project',
          valueToString: (String location) => location.toString(),
          builder: (DemoItem<String> item) {
            void close() {
              setState(() {
                item.isExpanded = false;
